    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-white p-0 opacity-70 hover:opacity-100 border-blue-200 hover:bg-blue-50 hover:border-blue-400 text-blue-600"
        ),
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 text-blue-600 hover:bg-blue-50 hover:text-blue-700"
        ),
        ...
        day_outside:
          "day-outside text-blue-300 opacity-50 aria-selected:bg-blue-50 aria-selected:text-blue-400 aria-selected:opacity-30",
